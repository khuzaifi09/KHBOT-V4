...
*/
const A187 = 'KhuzaifiGans'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/Khuzaifi09'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+6285655872206'; // JANGAN UBAH-UBAH INFO!!!
const aktif = 'Tergantung jaringan'; // JANGAN UBAH-UBAH INFO!!!
const groupwhatsapp = 'Blom ada'; // JANGAN UBAH-UBAH INFO!!!
const youtube = 'Blom ada'; // JANGAN UBAH-UBAH INFO!!!
//A187ID
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] KhuzaifiGans BOT Tinggal Di Scan`);
});
